          ...
          items: [
            'products/alloydb-omni/get-started',
            {
              ...
              items: [
                ...
                'products/alloydb-omni/connect/connect-psql',
                'products/alloydb-omni/connect/connect-pgadmin',
                'products/alloydb-omni/connect/connect-datagrip',
                'products/alloydb-omni/connect/connect-dbeaver',
              ],
            },
            'products/alloydb-omni/use-columnar-engine',
            'products/alloydb-omni/manage-credentials',
            'products/alloydb-omni/access-ai-models',
